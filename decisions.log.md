...
The full running log of the real calls made while building this — every ticket pass and every
implementation detail. [`decisions.md`](./decisions.md) is the curated record of the
load-bearing calls; this file is the blow-by-blow behind it.

The brief at the top was written before any code existed, as the problem statement asks.
Everything under "Decisions" was settled during planning or during the build, and the file gets
appended to as things change. Where I got something wrong and reversed it, the reversal stays
in.
