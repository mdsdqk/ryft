...
- **Action:** The row is the action — `source → main` opens `/merge/:id`. There is no create on this surface (that lives on the branch workspace). Empty points at `/branches`.
