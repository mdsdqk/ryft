...
const revisions: RevisionRef[] = [
  ...
  rev(7, "ours", SADIQ, "2026-08-29T09:27:00+05:30",
    { type: "addIndex", tableId: T, index: { id: "idx_ordered", columnIds: ["col_placed"], unique: false } },
  ...
  rev(9, "ours", SADIQ, "2026-08-29T09:33:00+05:30",
    { type: "addUnique", tableId: T, unique: { id: "uq_tracking", columnIds: ["col_tracking"] } },
    "add unique uq_tracking on col_tracking"),
  rev(10, "ours", SADIQ, "2026-08-29T09:36:00+05:30",
    {
      type: "addForeignKey",
      tableId: T,
      fk: { id: "fk_coupon", columnIds: ["col_coupon"], refTableId: "tbl_coupons", refColumnIds: ["col_coupons_code"], onDelete: "set null" },
    },
  ...
  rev(17, "theirs", OKAFOR, "2026-08-28T22:20:00+05:30",
    {
      ...
      tableId: T,
      indexId: "idx_status",
      from: { columnIds: ["col_status"], unique: false },
      to: { columnIds: ["col_status", "col_placed"], unique: false },
    },
